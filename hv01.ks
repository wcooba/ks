...
# Network information
network  --bootproto=static --device=em1 --gateway=10.0.0.1 --ip=10.0.0.32 --nameserver=10.0.0.1,10.0.0.6 --netmask=255.255.255.0 --onboot=yes --noipv6
...
network  --hostname=gigatron-hv01.automaticamusments.local
